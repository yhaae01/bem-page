                ...
                <tbody>
                    ...
                    <?php foreach ($users as $u) : ?>
                        <tr>
                            ...
                            <td><img src="<?= base_url('assets/img/Kemenkominfo/') . $u['image']; ?>" height="50"></td>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="<?= base_url('content/deleteKemenkominfo/') . $u['id']; ?>" method="post">
                        ...
                        <div class="modal fade" id="ubahUser<?= $u['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="ubahUserLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <?php echo form_open_multipart('content/editKemenkominfo'); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img class="mb-3" src="<?= base_url('assets/img/kemenkominfo/') . $u['image']; ?>" height="100">
...
<div class="modal fade" id="tambahUser" tabindex="-1" role="dialog" aria-labelledby="tambahUserLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open_multipart('content/insertKemenkominfo'); ?>
                <div class="form-group">
                    <label for="name">Nama</label>
