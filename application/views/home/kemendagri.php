                ...
                <tbody>
                    ...
                    <?php foreach ($users as $u) : ?>
                        <tr>
                            ...
                            <td><img src="<?= base_url('assets/img/Kemendagri/') . $u['image']; ?>" height="50"></td>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="<?= base_url('content/deleteKemendagri/') . $u['id']; ?>" method="post">
                        ...
                        <div class="modal fade" id="ubahUser<?= $u['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="ubahUserLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <?php echo form_open_multipart('content/editKemendagri'); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img class="mb-3" src="<?= base_url('assets/img/kemendagri/') . $u['image']; ?>" height="100">
...
<div class="modal fade" id="tambahUser" tabindex="-1" role="dialog" aria-labelledby="tambahUserLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open_multipart('content/insertKemendagri'); ?>
                <div class="form-group">
                    <label for="name">Nama</label>
