                ...
                <tbody>
                    ...
                    <?php foreach ($users as $u) : ?>
                        <tr>
                            ...
                            <td><img src="<?= base_url('assets/img/Kemenlu/') . $u['image']; ?>" height="50"></td>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="<?= base_url('content/deleteKemenlu/') . $u['id']; ?>" method="post">
                        ...
                        <div class="modal fade" id="ubahUser<?= $u['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="ubahUserLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <?php echo form_open_multipart('content/editKemenlu'); ?>
...
<div class="modal fade" id="tambahUser" tabindex="-1" role="dialog" aria-labelledby="tambahUserLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open_multipart('content/insertKemenlu'); ?>
                <div class="form-group">
                    <label for="name">Nama</label>
